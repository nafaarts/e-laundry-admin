...
@section('content')
    ...
    <div class="page-body">
        ...
        <form action="{{ route('service.store', ['laundry' => request('laundry')]) }}" method="POST" class="card"
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                        placeholder="{{ __('Nama Layanan') }}" value="{{ old('name') }}" required>
                    @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror"
                                placeholder="{{ __('Satuan') }}" value="{{ old('unit') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror"
                                placeholder="{{ __('Harga') }}" value="{{ old('price') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                        placeholder="{{ __('Deskripsi') }}" value="{{ old('description') }}" required>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="icon" class="form-control @error('icon') is-invalid @enderror" required
                        onchange="preview()">
                    <small>*Ukuran icon 100*100 px</small>
                    @error('icon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
